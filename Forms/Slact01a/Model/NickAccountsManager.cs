...
namespace Alio.Forms.Slact01a.Model{
	public partial class NickAccountsManager: ComposableDBBusinessObject<NickAccountsAdapter>
	{
		public NickAccountsManager(AbstractComposableModel model, BusinessObjectMetadata metadata) : base(model, metadata)
        {
        }
